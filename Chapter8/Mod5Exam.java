...
class Mod5ExamPart1 {
	...
	public static void printExam() {
		...
		double[] scores;											// Array to stoe exam scores
		scores = new double[25];									// Set size of array to 25 (number of students)
		int a = 0, b = 0, c = 0, d = 0, f = 0;						// Initialize grades
		double sum = 0, average = 0;								// Decalre average and sum, used for calculating average
		System.out.print( "\nEnter 25 exam scores: " );				// Prompt user for input
		for ( int i = 0; i < 25; i++ ) {							// Begin loopoing through scores[] for exam grade
	...
	public static void trackAtt() {
		...
		System.out.println("\nStudent Attendance: ");				// Begin print of attendance
		for (int r = 0; r < att.length; r++) {						// Loop though each row
			System.out.print( "\n" );								// Print new line
